...
ADDRESSABLES_FOLDER="Assets/AddressableAssetsData"
UX_PACKAGE=UX.unitypackage
IMAGE_PACKAGE=ImageTracking.unitypackage

$UNITY_PATH -batchmode -nographics -quit -projectPath $PROJECT_PATH -exportPackage $COMMON_FOLDER $UX_FOLDER $ADDRESSABLES_FOLDER "$PACKAGE_PATH$UX_PACKAGE"
